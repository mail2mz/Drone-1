...
//Setup i2c client to receive message from mcu8266 as i2c client address=8
 Wire.begin(8);                /* join i2c bus with address 8 */
 Wire.onReceive(receiveEvent); /* register receive event */

//Setup serial port for debuging
...
*/
//Add display and delay for debugging
 Serial.print("   |   ");
 Serial.print("Xº: ");
...
//Code bellow is 
//Processing command from mpc8266
//
